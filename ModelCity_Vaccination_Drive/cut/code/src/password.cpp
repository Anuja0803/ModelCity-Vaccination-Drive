 ...
 *   FILENAME    :   Password.c
 *
 *   DESCRIPTION :   This file is used for masking and checking the password while 
 *                   admin logs in
 *            
 *
 *   REVISION HISTORY
 ...
 *  -------------------------------------------
 *   
 *   22/09/2022    Username           Validate password
 *
 * ***********************************************************************************/
...
int checkpassword() //Validating passwords for Admin corner
{
	char pw[MAXPW]={0};
	char *p=pw;
